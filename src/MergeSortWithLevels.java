...
Este c�digo executa as modifica��es previstas nos slides 20, 21 e 22 do material de Washington.
...
Modificado por: Prof. Me. Luiz M�rio Lustosa Pascoal
*/
...
public class MergeSortWithLevels {
	...
	public static void main(String[] args) throws Throwable {
		...
		int RUNS = 25; // quantas execu��es ser�o testadas?
 ...
 * Ela realiza a execu��o do MergeSort em um array. A ideia � que o agoritmo
 * paralelo do MergeSort possa criar v�rios "Ordenadores", cada um para um
 * pequeno espa�o do array. Ao final, uma thread ir� unir as pequenas partes
